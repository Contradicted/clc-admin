...
const formSchema = z.object({
  credits: z.coerce.number().min(1, {
    message: "Credits must be at least 1 or more",
  }),
});

const CreditsForm = ({ initialData, courseID }) => {
        ...
        {!isEditing && (
          <p
            className={cn(
              ...
              !initialData.credits && "italic"
            )}
          >
            {initialData.credits || "Credits have not been set"}
          </p>
        )}
        {isEditing && (
          <Form {...form}>

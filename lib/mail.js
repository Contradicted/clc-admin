...
export const sendConditionalLetterOfAcceptanceEmail = async (
  ...
  const replacements = {
    ...
    startDate: formatDateTime(courseDates.start_date).dateLong,
    lastJoinDate: formatDateTime(courseDates.last_join_date).dateLong,
    endDate: formatDateTime(courseDates.end_date).dateLong,
    resultsDate: formatDateTime(courseDates.results_date).dateLong,

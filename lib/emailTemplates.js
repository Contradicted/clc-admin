    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>Dear {firstName + " " + lastName},</Text>
          <Text style={text}>
            Your City of London College student account has been created and is ready to use.
            Please find your account details below:
          </Text>

          <Section style={{ padding: "20px", margin: "20px 0", backgroundColor: "#f9f9f9", borderRadius: "5px"}}>
            <Text style={sectionText}>
          ...
          <Text style={text}>
            ...
            <br />
            2. This email account will be used for all official college communications
            <br />
            3. You can access your email at <Link href="https://outlook.office.com">here</Link>
          </Text>

          <Text style={text}>
            If you have any issues accessing your account, please contact our IT support.
          </Text>
        ...
        <Section>
          ...
          <div style={{ marginTop: "20px", marginBottom: "20px" }}>
            ...
            <a href={saveUrl} style={{ display: "inline-block", marginRight: "10px" }}>
              <img
                src="https://res.cloudinary.com/dt7hzfiwq/image/upload/f_auto,q_auto/wnyjmslrg63bkb7h4hbp"
            ...
            >
              <img
                src="https://res.cloudinary.com/dt7hzfiwq/image/upload/v1734536383/k3s9fnzngff0aydp8jop.png"

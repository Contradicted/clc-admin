  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Congratulations! We are pleased to offer you an enrollment letter. Please see follow-up email
  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Congratulations! We are pleased to offer you a conditional letter of acceptance. Please see follow-up email
...
export const WithdrawnEmailTemplate = ({ firstName, lastName, emailMsg, courseTitle, awardingBody }) => {
  return (
    <Html>
      <Head />
      <Preview>Hi {firstName},</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
           Unfortunately, your application for the {courseTitle} with {awardingBody} has been withdrawn. As a result, you have now been withdrawn from the course. 
          </Text>

          <Text style={text}>
           Your record at the College is now closed.
          </Text>
...
export const Office365EmailTemplate = ({
  firstName,
  lastName,
  email,
  password
  ...
  return (
    <Html>
      <Head />
      <Preview>Your City of London College student email account is ready</Preview>
      <Body style={main}>
      <Container style={container}>
        <Img
          src="https://www.clc-london.ac.uk/wp-content/uploads/2024/02/CLC-322-strapline-1-scaled-3.jpg"
        ...
        <Text style={text}>
          Your City of London College student email account has been created and
          is ready to use. Please find your account details below:
        </Text>
        ...
        >
          <Heading style={{ margin: "0 0 15px 0", color: "#ff6f00", fontSize: "16px" }}>
          ...
          >
            <Text style={{ margin: "0" }}>
              <strong>Email Address:</strong> {office365Email}
            </Text>
          </Section>
          <Section
            style={{
          ...
          >
            <Text style={{ margin: "0" }}>
              <strong>Temporary Password:</strong> {office365Password}
            </Text>
          </Section>
        </Section>
        ...
        >
          <Heading style={{ margin: "0 0 10px 0", color: "#e74c3c", fontSize: "16px" }}>
            Important Information
          </Heading>
          <List type="ordered" style={{ margin: "10px 0", paddingLeft: "25px", lineHeight: "1.5" }}>
            <Item>You <strong>must</strong> change your password when you first log in</Item>
            <Item>This email account will be used for all official college communications</Item>
            <Item>You can access your email at <Link href="https://outlook.office.com" style={{ color: "#0078d4", textDecoration: "underline" }}>outlook.office.com</Link></Item>
          </List>
        </Section>
        ...
        >
          <Heading style={{ margin: "0 0 10px 0", color: "#0078d4", fontSize: "16px" }}>
            Managing Your Assignments
          </Heading>
          
          <Heading style={{ margin: "15px 0 5px 0", color: "#0078d4", fontSize: "14px" }}>
            Accessing Assignments:
          </Heading>
          <List type="ordered" style={{ margin: "5px 0 15px 0", paddingLeft: "25px", lineHeight: "1.5" }}>
            <Item>Log in to Microsoft Teams by clicking <Link href="https://teams.microsoft.com" style={{ color: "#0078d4", textDecoration: "underline" }}>here</Link> or by visiting <Link href="https://teams.microsoft.com" style={{ color: "#0078d4", textDecoration: "underline" }}>teams.microsoft.com</Link></Item>
            <Item>Click on the "Teams" tab</Item>
            <Item>Click on the class name</Item>
            <Item>Click on the "Assignments" tab</Item>
          </List>
          
          <Heading style={{ margin: "15px 0 5px 0", color: "#0078d4", fontSize: "14px" }}>
            Submitting Assignments:
          </Heading>
          <List type="ordered" style={{ margin: "5px 0", paddingLeft: "25px", lineHeight: "1.5" }}>
            <Item>Follow steps 1-4 above to access your assignments</Item>
            <Item>Click on the assignment name</Item>
            <Item>Click on the "Turnitin Assignment" button</Item>
            <Item>Upload your work and submit before the deadline</Item>
          </List>
          
          <Text style={{ margin: "15px 0 0 0", lineHeight: "1.5", fontStyle: "italic" }}>
            Please ensure that you read all instructions carefully and submit your assignments on time. Late submissions may result in grade penalties.
          </Text>
        </Section>
        ...
        >
          ...
          <List type="ordered" style={{ margin: "10px 0", paddingLeft: "25px", lineHeight: "1.5" }}>
            ...
            <Item>Click on the "Teams" tab</Item>
            <Item>Click on the class name</Item>
            <Item>Click on the General channel</Item>
            <Item>Click on the "Files" tab at the top</Item>
          </List>
          <Text style={{ margin: "10px 0", lineHeight: "1.5" }}>
            From there, you will see a "Class Materials" folder which contains all your course resources.
          </Text>
        </Section>

        <Text style={text}>
          For guidance on how to setup your account, please watch this video <Link href="https://www.youtube.com/watch?v=sup6jQ6C85o">here</Link>.
        </Text>
  ...
  return (  
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section>
          <Text style={sectionText}>
            Your digital student ID card for City of London College has been generated and is ready to be added to your digital wallet.
          </Text>
          <Text style={sectionText}>
            Click the button below to add your student ID to your digital wallet:
          </Text>
          <div style={{ marginTop: "20px", marginBottom: "20px" }}>
            {/* Google Wallet Button */}
            <a href={saveUrl} style={{ display: "inline-block", marginRight: "10px" }}>
              <img
          ...
          <Text style={sectionText}>
            If you have any issues accessing your digital ID, please contact our IT support team.
          </Text>
          <Hr style={hr} />
          <Text style={footer}>
